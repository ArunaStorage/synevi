...
impl ConsensusTransport for ReplicaBox {
    async fn pre_accept(
        ...
        Ok(Response::new(self.inner.pre_accept(request.into_inner()).await.map_err(|e| tonic::Status::internal(e.to_string()))?))
    }
    ...
    async fn accept(
        ...
        Ok(Response::new(self.inner.accept(request.into_inner()).await.map_err(|e| tonic::Status::internal(e.to_string()))?))
    }
    ...
    async fn commit(
        ...
        Ok(Response::new(self.inner.commit(request.into_inner()).await.map_err(|e| tonic::Status::internal(e.to_string()))?))
    }
    ...
    async fn apply(
        ...
        Ok(Response::new(self.inner.apply(request.into_inner()).await.map_err(|e| tonic::Status::internal(e.to_string()))?))
    }
    ...
    async fn recover(
        ...
        Ok(Response::new(self.inner.recover(request.into_inner()).await.map_err(|e| tonic::Status::internal(e.to_string()))?))
    }
}
